...
var pizzas = []models.Pizza{
	...
	{ID: 4, Name: "calabrese sausage with onions", Description: "Pizza with Italian calabrese sausage, mozzarella, olives, garlic and onions rings.", Price: 4.99, Size: "small"},
	{ID: 5, Name: "four cheese pizza", Description: "Pizza with gorgonzola ,provolone, parmesan, mozzarella, olives and pasta suace.", Price: 54.99, Size: "extra large"},
}
